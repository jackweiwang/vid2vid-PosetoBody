...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--n_frames_D', type=int, default=5, help='number of frames to feed into temporal discriminator')
        ...
        self.parser.add_argument('--n_frames_total', type=int, default=50, help='the overall number of frames in a sequence to train with')
